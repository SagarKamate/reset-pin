                    ...
                    <Segment attached={"bottom"}>
                        ...
                        <Step.Group attached='top' widths={5}>
                            ...
                            <Step
                                ...
                                //disabled={this.state.stepTitle === "Preference" || this.state.stepCompleted === "Preference" ? true : false}
                                completed={
                                    (this.state.stepCompleted === "Debit Card"
                                        || this.state.stepCompleted === "OTP"
                                        || this.state.stepCompleted === "Reset PIN")
                            ...
                            <Step
                                ...
                                //disabled={this.state.stepTitle !== "OTP" ? true : false}
                                completed={
                                    (this.state.stepCompleted === "OTP"
                                        || this.state.stepCompleted === "Reset PIN")
                                        ?
                            ...
                            <Step
                                link
                                active={this.state.stepCompleted === "OTP" ? true : false}
                                //disabled={this.state.stepCompleted !== "Reset PIN" ? true : false}
                            ...
                            <Step
                                link
                                active={this.state.stepCompleted === "Reset PIN" ? true : false}
